...
export const useAnimationValues = () => {
  ...
  // Criamos 8 valores para campos comuns + condicionais
  const { opacityValues: inputsOpacity, translateYValues: inputsTranslateY } = createAnimatedValues(8);
  
  // Valores para o botão de cadastro
